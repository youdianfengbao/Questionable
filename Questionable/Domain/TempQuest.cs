...
public unsafe readonly struct TempQuest(ExcelPage page, uint offset, uint row) : IExcelRow<TempQuest>
{
    ...
    public readonly RowRef<Emote> EmoteReward => new(page.Module, page.ReadUInt16(offset + 2614), page.Language);
    public readonly RowRef<Action> ActionReward => new(page.Module, page.ReadUInt16(offset + 2616), page.Language);
    ...
    public readonly RowRef<QuestRewardOther> OtherReward => new(page.Module, page.ReadUInt8(offset + 2657), page.Language);
    ...
    public readonly RowRef<Festival> Festival => new(page.Module, page.ReadUInt16(offset + 2746), page.Language);
    ...
    public readonly SubrowRef<Behavior> ClientBehavior => new(page.Module, page.ReadUInt16(offset + 2754), page.Language);
    public readonly SubrowRef<QuestClassJobSupply> QuestClassJobSupply => new(page.Module, page.ReadUInt16(offset + 2756), page.Language);
    public readonly RowRef<PlaceName> PlaceName => new(page.Module, page.ReadUInt16(offset + 2758), page.Language);
    public readonly ushort SortKey => page.ReadUInt16(offset + 2760);
    public readonly RowRef<ExVersion> Expansion => new(page.Module, page.ReadUInt8(offset + 2762), page.Language);
    public readonly RowRef<ClassJobCategory> ClassJobCategory0 => new(page.Module, page.ReadUInt8(offset + 2763), page.Language);
    public readonly byte QuestLevelOffset => page.ReadUInt8(offset + 2764);
    public readonly RowRef<ClassJobCategory> ClassJobCategory1 => new(page.Module, page.ReadUInt8(offset + 2765), page.Language);
    ...
    public readonly RowRef<ClassJob> ClassJobUnlock => new(page.Module, page.ReadUInt8(offset + 2771), page.Language);
    public readonly RowRef<GrandCompany> GrandCompany => new(page.Module, page.ReadUInt8(offset + 2772), page.Language);
    public readonly RowRef<GrandCompanyRank> GrandCompanyRank => new(page.Module, page.ReadUInt8(offset + 2773), page.Language);
    ...
    public readonly RowRef<BeastTribe> BeastTribe => new(page.Module, page.ReadUInt8(offset + 2777), page.Language);
    public readonly RowRef<BeastReputationRank> BeastReputationRank => new(page.Module, page.ReadUInt8(offset + 2778), page.Language);
    public readonly RowRef<SatisfactionNpc> SatisfactionNpc => new(page.Module, page.ReadUInt8(offset + 2779), page.Language);
    public readonly byte SatisfactionLevel => page.ReadUInt8(offset + 2780);
    public readonly RowRef<DeliveryQuest> DeliveryQuest => new(page.Module, page.ReadUInt8(offset + 2781), page.Language);
    public readonly byte RepeatIntervalType => page.ReadUInt8(offset + 2782);
    public readonly RowRef<QuestRepeatFlag> QuestRepeatFlag => new(page.Module, page.ReadUInt8(offset + 2783), page.Language);
    ...
    public readonly RowRef<ClassJob> ClassJobRequired => new(page.Module, page.ReadUInt8(offset + 2787), page.Language);
    public readonly RowRef<QuestRewardOther> QuestRewardOtherDisplay => new(page.Module, page.ReadUInt8(offset + 2788), page.Language);
    public readonly byte Unknown10 => page.ReadUInt8(offset + 2789);
    public readonly RowRef<EventIconType> EventIconType => new(page.Module, page.ReadUInt8(offset + 2790), page.Language);
    /// <summary>
    ///     1/2 - normal daily beast tribe quests, 3 - 'exclusive' (if player's rank is not greater than max rank requirement
    ///     of quests offered by npc, exactly one of the available quests will be from this pool)
    /// </summary>
